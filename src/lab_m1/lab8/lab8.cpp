...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0, 1, 0));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int type = glGetUniformLocation(shader->program, "typeLight");
    glUniform1i(type, typeLight);

    GLuint light_position = glGetUniformLocation(shader->program, "point_light_pos");
